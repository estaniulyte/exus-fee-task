  ...
  return (
    <div>
      <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        ...
        >
          <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-primary-300">
            <ul className="space-y-2 font-medium">
              <a href="https://www.exus.ai/" className="flex items-center uppercase pl-2.5 mb-5">
                <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Exus AI Labs</span>
              </a>
              <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-primary-400">
